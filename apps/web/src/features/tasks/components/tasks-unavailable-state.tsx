...
const reasonMessage: Record<TasksUnavailableReason, string> = {
  rate_limited: 'The API rate limit was reached and no valid task snapshot is available.',
  server_error: 'The API returned an error and no valid task snapshot is available.',
  network_error: 'The API could not be reached and no valid task snapshot is available.',
