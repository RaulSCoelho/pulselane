import type { ProjectsUnavailableReason } from '@/features/projects/api/server-queries'
import { Card } from '@heroui/react'

type ProjectsUnavailableStateProps = {
...
export function ProjectsUnavailableState({ reason }: ProjectsUnavailableStateProps) {
  return (
    <Card className="border border-black/5">
      <Card.Content className="flex flex-col gap-2 p-8">
        <h2 className="text-xl font-semibold tracking-tight">Projects temporarily unavailable</h2>
