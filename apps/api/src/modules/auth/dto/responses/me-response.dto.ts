...
class MeOrganizationDto extends PickType(OrganizationResponseDto, ['id', 'name', 'slug'] as const) {}

class MeMembershipDto extends PickType(MembershipResponseDto, ['id', 'role'] as const) {
...
export class MeResponseDto extends IntersectionType(UserResponseDto, MeExtraDto) {}
