...
export class SessionResponseDto {
  ...
  @ApiProperty({
    ...
    nullable: true,
    description:
      'IP address used when the session was created or last used (may be null)',
  })
  ...
  @ApiProperty({
    ...
    nullable: true,
    description:
      'Last time this session was used (updated on refresh or API usage)',
  })
  ...
  @ApiProperty({
    ...
    description:
      'Expiration date of the session (based on refresh token lifetime)',
  })
  expiresAt!: Date;
  ...
  @ApiProperty({
    ...
    nullable: true,
    description:
      'Date when the session was marked as compromised (e.g. token mismatch / possible theft)',
  })
  ...
  @ApiProperty({
    example: true,
    description:
      'Indicates if this session is the current one (based on access token sessionId)',
  })
  isCurrent!: boolean;
